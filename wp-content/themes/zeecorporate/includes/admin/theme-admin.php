...
function themezee_admin_add_page() {
	add_theme_page(THEMEZEE_NAME.' '. __('Настройки', 'themezee_lang'), THEMEZEE_NAME.' '. __('Настройки', 'themezee_lang'), 'edit_theme_options', 'themezee', 'themezee_options_page');
}
	...
	<div class="wrap zee_admin_wrap">  			
		...
		<div id="zee_admin_header">
			...
			<div id="zee_admin_menu">
				<ul>
					<li><a href="<?php echo THEMEZEE_INFO; ?>">Информация о теме. <span>Смотрите детали</span></a></li>
					<li><a href="http://themezee.com">Другие темы WordPress<span>Все бесплатные темы WordPress</span></a></li>
				</ul>
			</div>
			<div class="clear"></div>
		</div>
		...
		<h2><?php echo THEMEZEE_NAME; ?> <?php _e('Настройки', 'themezee_lang'); ?></h2>
		
		<p><?php _e('Совершенно по вашему желанию, вы можете оставить ссылку на автора в нижней части сайта.', 'themezee_lang'); ?></p>

			<?php if ( isset( $_GET['settings-updated'] ) ) : ?>
				<div class='updated'><p><?php _e('Настройки темы успешно обновлены.', 'themezee_lang'); ?></p></div>
			<?php endif; ?>
			
			<form class="zee_form" action="options.php" method="post">
				<p><input name="Submit" class="button-primary" type="submit" value="<?php esc_attr_e('Сохранить изменения', 'themezee_lang'); ?>" /></p>
